      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[60vh]">
        ...
        <div className="space-y-8 relative z-10">
          ...
          <div className="flex gap-4">
            <Link href="/vision" className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-xl font-bold transition-all shadow-lg shadow-blue-500/25 flex items-center cursor-pointer hover:scale-105 active:scale-95">
